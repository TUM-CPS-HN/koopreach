function [R, res, Verror] = reach_Koopman(nlnsysDT,params,options,varargin)
...
for i = 1:steps
    ...
    options.i = i;
     params.U = zonotope(options.U_full(:,i),params.U.generators);

    % compute next reachable set
    [Rnext,options,Verror.L_x{i+1}] = linReach_Koopman(nlnsysDT,Rnext,params,options);
